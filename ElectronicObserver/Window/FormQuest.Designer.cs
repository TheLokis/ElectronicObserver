namespace ElectronicObserver.Window
{
	partial class FormQuest
	{
		...
		private void InitializeComponent()
		{
			...
			this.QuestView_Type.HeaderText = "종류";
			...
			this.QuestView_Category.HeaderText = "분류";
			...
			this.QuestView_Name.HeaderText = "이름";
			...
			this.MenuProgress_Decrement.Text = "진행도 -1(&D)";
			...
			this.MenuProgress_Reset.Text = "진행도 리셋(&R)";
			...
			this.MenuMain_ColumnFilter.Text = "열 필터(&C)";
			// 
			...
			this.MenuMain_ColumnFilter_State.Text = "진행중(&S)";
			...
			this.MenuMain_ColumnFilter_Category.Text = "분류(&C)";
			...
			this.MenuMain_ColumnFilter_Name.Text = "이름(&N)";
			...
			this.MenuMain_ColumnFilter_Progress.Text = "진행도(&P)";
			...
			this.MenuMain_Initialize.Text = "초기화(&I)";
			...
			this.MenuMain_QuestFilter.Text = "필터설정(&Q)";
			// 
			// MenuMain_ShowWeekly
			// 
			...
			this.MenuMain_ShowWeekly.Text = "주간임무 표시(&W)";
			...
			this.MenuMain_ShowDaily.Text = "일일임무 표시(&D)";
			...
			this.MenuMain_ShowRunningOnly.Text = "진행중인것만 표시(&R)";
			...
			this.MenuMain_ShowMonthly.Text = "월간임무 표시(&M)";
			...
			this.MenuMain_ShowOther.Text = "기타 임무 표시(&R)";
			...
			this.MenuMain_GoogleQuest.Text = "이름으로 Google 검색(&G)";
