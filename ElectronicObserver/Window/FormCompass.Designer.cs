namespace ElectronicObserver.Window
{
	partial class FormCompass
	{
		...
		private void InitializeComponent()
		{
			...
			this.TextEventDetail.Text = "(이벤트 상세)";
			...
			this.TextEnemyFleetName.Text = "(적함대명)";
			...
			this.TextAirSuperiority.Text = "(제공전력)";
			// 
			// ToolTipInfo
			// 
