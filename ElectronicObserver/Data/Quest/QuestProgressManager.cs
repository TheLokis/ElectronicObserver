                ...
                if (!this.Progresses.ContainsKey(q.QuestID))
                {
                    ...
                    switch (q.QuestID)
                    {
                        ...
                        case 201:   //|201|敵艦隊を撃破せよ！|勝利1
                            this.Progresses.Add(new ProgressBattle(q, 1, "B", null, false));
                            break;
                        case 216:   //|216|敵艦隊主力を撃滅せよ！|戦闘1
                            this.Progresses.Add(new ProgressBattle(q, 1, "E", null, false));
                            break;
                        case 210:   //|210|敵艦隊を10回邀撃せよ！|戦闘10
                            this.Progresses.Add(new ProgressBattle(q, 10, "E", null, false));
                            break;
                        case 211:   //|211|敵空母を3隻撃沈せよ！|空母3
                            this.Progresses.Add(new ProgressSlaughter(q, 3, new[] { 7, 11 }));
                            break;
                        case 212:   //|212|敵輸送船団を叩け！|輸送5
                            this.Progresses.Add(new ProgressSlaughter(q, 5, new[] { 15 }));
                            break;
                        case 218:   //|218|敵補給艦を3隻撃沈せよ！|輸送3
                            this.Progresses.Add(new ProgressSlaughter(q, 3, new[] { 15 }));
                            break;
                        case 226:   //|226|南西諸島海域の制海権を握れ！|2-(1~5)ボス勝利5
                            this.Progresses.Add(new ProgressBattle(q, 5, "B", new[] { 21, 22, 23, 24, 25 }, true));
                            break;
                        case 230:   //|230|敵潜水艦を制圧せよ！|潜水6
                            this.Progresses.Add(new ProgressSlaughter(q, 6, new[] { 13 }));
                            break;

                        case 213:   //|213|海上通商破壊作戦|輸送20
                            this.Progresses.Add(new ProgressSlaughter(q, 20, new[] { 15 }));
                            break;
                        case 214:   //|214|あ号作戦|出撃36/S勝利6/ボス24/ボス勝利12
                            this.Progresses.Add(new ProgressAGo(q));
                            break;
                        case 220:   //|220|い号作戦|空母20
                            this.Progresses.Add(new ProgressSlaughter(q, 20, new[] { 7, 11 }));
                            break;
                        case 221:   //|221|ろ号作戦|輸送50
                            this.Progresses.Add(new ProgressSlaughter(q, 50, new[] { 15 }));
                            break;
                        case 228:   //|228|海上護衛戦|潜水15
                            this.Progresses.Add(new ProgressSlaughter(q, 15, new[] { 13 }));
                            break;
                        case 229:   //|229|敵東方艦隊を撃滅せよ！|4-(1~5)ボス勝利12
                            this.Progresses.Add(new ProgressBattle(q, 12, "B", new[] { 41, 42, 43, 44, 45 }, true));
                            break;
                        case 242:   //|242|敵東方中枢艦隊を撃破せよ！|4-4ボス勝利1
                            this.Progresses.Add(new ProgressBattle(q, 1, "B", new[] { 44 }, true));
                            break;
                        case 243:   //|243|南方海域珊瑚諸島沖の制空権を握れ！|5-2ボスS勝利2
                            this.Progresses.Add(new ProgressBattle(q, 2, "S", new[] { 52 }, true));
                            break;
                        case 261:   //|261|海上輸送路の安全確保に努めよ！|1-5ボスA勝利3
                            this.Progresses.Add(new ProgressBattle(q, 3, "A", new[] { 15 }, true));
                            break;
                        case 241:   //|241|敵北方艦隊主力を撃滅せよ！|3-(3~5)ボス勝利5
                            this.Progresses.Add(new ProgressBattle(q, 5, "B", new[] { 33, 34, 35 }, true));
                            break;

                        case 249:   //|249|月|「第五戦隊」出撃せよ！|2-5ボスS勝利1|要「那智」「妙高」「羽黒」
                            this.Progresses.Add(new ProgressSpecialBattle(q, 1, "S", new[] { 25 }, true));
                            break;
                        case 256:   //|256|「潜水艦隊」出撃せよ！|6-1ボスS勝利3
                            this.Progresses.Add(new ProgressBattle(q, 3, "S", new[] { 61 }, true));
                            break;
                        case 257:   //|257|月|「水雷戦隊」南西へ！|1-4ボスS勝利1|要軽巡旗艦、軽巡3隻まで、他駆逐艦　他艦種禁止
                            this.Progresses.Add(new ProgressSpecialBattle(q, 1, "S", new[] { 14 }, true));
                            break;
                        case 259:   //|259|月|「水上打撃部隊」南方へ！|5-1ボスS勝利1|要(大和型or長門型or伊勢型or扶桑型)3/軽巡1　巡戦禁止、戦艦追加禁止
                            this.Progresses.Add(new ProgressSpecialBattle(q, 1, "S", new[] { 51 }, true));
                            break;
                        case 264:   //|264|月|「空母機動部隊」西へ！|4-2ボスS勝利1|要(空母or軽母or装母)2/駆逐2
                            this.Progresses.Add(new ProgressSpecialBattle(q, 1, "S", new[] { 42 }, true));
                            break;
                        ...
                        case 265:   //|265|海上護衛強化月間|1-5ボスA勝利10
                            this.Progresses.Add(new ProgressBattle(q, 10, "A", new[] { 15 }, true));
                            break;
                        ...
                        case 861:   //|861|季|強行輸送艦隊、抜錨！|1-6終点到達2|要(航空戦艦or補給艦)2
                            this.Progresses.Add(new ProgressSpecialBattle(q, 2, "x", new[] { 16 }, true));
                            break;
                        case 862:   //|862|季|前線の航空偵察を実施せよ！|6-3ボスA勝利2|要水母1軽巡2
                            this.Progresses.Add(new ProgressSpecialBattle(q, 2, "A", new[] { 63 }, true));
                            break;
                        ...
                        case 875:   //|875|季|精鋭「三一駆」、鉄底海域に突入せよ！|5-4ボスS勝利2|要長波改二/(高波改or沖波改or朝霜改)
                            this.Progresses.Add(new ProgressSpecialBattle(q, 2, "S", new[] { 54 }, true));
                            break;
                        ...
                        case 304:   //|304|「演習」で他提督を圧倒せよ！|演習勝利5
                            this.Progresses.Add(new ProgressPractice(q, 5, true));
                            break;
                        case 302:   //|302|大規模演習|演習勝利20
                            this.Progresses.Add(new ProgressPractice(q, 20, true));
                            break;
                        case 311:   //|311|精鋭艦隊演習|演習勝利7|マンスリーだが1日で進捗リセット
                            this.Progresses.Add(new ProgressPractice(q, 7, true));
                            break;

                        case 402:   //|402|「遠征」を3回成功させよう！|遠征成功3
                            this.Progresses.Add(new ProgressExpedition(q, 3, null));
                            break;
                        case 403:   //|403|「遠征」を10回成功させよう！|遠征成功10
                            this.Progresses.Add(new ProgressExpedition(q, 10, null));
                            break;
                        case 404:   //|404|大規模遠征作戦、発令！|遠征成功30
                            this.Progresses.Add(new ProgressExpedition(q, 30, null));
                            break;
                        case 410:   //|410|南方への輸送作戦を成功させよ！|「東京急行」「東京急行(弐)」成功1
                            this.Progresses.Add(new ProgressExpedition(q, 1, new[] { 37, 38 }));
                            break;
                        case 411:   //|411|南方への鼠輸送を継続実施せよ！|「東京急行」「東京急行(弐)」成功6
                            this.Progresses.Add(new ProgressExpedition(q, 6, new[] { 37, 38 }));
                            this.Progresses[q.QuestID].SharedCounterShift = 1;
                            break;
                        case 424:   //|424|月|輸送船団護衛を強化せよ！|「海上護衛任務」成功4
                            this.Progresses.Add(new ProgressExpedition(q, 4, new[] { 5 }));
                            this.Progresses[q.QuestID].SharedCounterShift = 1;
                            break;
                        ...
                        case 504:   //|504|艦隊酒保祭り！|補給15回
                            this.Progresses.Add(new ProgressSupply(q, 15));
                            break;

                        case 605:   //|605|新装備「開発」指令|開発1
                            this.Progresses.Add(new ProgressDevelopment(q, 1));
                            break;
                        case 606:   //|606|新造艦「建造」指令|建造1
                            this.Progresses.Add(new ProgressConstruction(q, 1));
                            break;
                        case 607:   //|607|装備「開発」集中強化！|開発3
                            this.Progresses.Add(new ProgressDevelopment(q, 3));
                            this.Progresses[q.QuestID].SharedCounterShift = 1;
                            break;
                        case 608:   //|608|艦娘「建造」艦隊強化！|建造3
                            this.Progresses.Add(new ProgressConstruction(q, 3));
                            this.Progresses[q.QuestID].SharedCounterShift = 1;
                            break;
                        case 609:   //|609|軍縮条約対応！|解体2
                            this.Progresses.Add(new ProgressDestruction(q, 2));
                            break;
                        case 619:   //|619|装備の改修強化|装備改修1(失敗可)
                            this.Progresses.Add(new ProgressImprovement(q, 1));
                            break;
                        case 673:   //|673|装備開発力の整備|小口径主砲廃棄4個|進捗は1/5から始まる(3個廃棄時点で80%達成になる)
                            this.Progresses.Add(new ProgressDiscard(q, 4, true, new[] { 1 }));
                            this.Progresses[q.QuestID].SharedCounterShift = 1;
                            break;
                        case 674:   //|674|工廠環境の整備|機銃廃棄3個,鋼材300保有|進捗は2/5から始まる(2個廃棄時点で80%達成になる)
                            this.Progresses.Add(new ProgressDiscard(q, 3, true, new[] { 21 }));
                            this.Progresses[q.QuestID].SharedCounterShift = 2;
                            break;
                        case 613:   //|613|資源の再利用|廃棄24回
                            this.Progresses.Add(new ProgressDiscard(q, 24, false, null));
                            break;
                        case 638:   //|638|対空機銃量産|機銃廃棄6個|回ではない
                            this.Progresses.Add(new ProgressDiscard(q, 6, true, new[] { 21 }));
                            break;
                        ...
                        case 628:   //|628|月|機種転換|零式艦戦21型(熟練)>>装備の空母旗艦, 零式艦戦52型x2廃棄
                            this.Progresses.Add(new ProgressDiscard(q, 2, true, new[] { 21 }, -1));
                            break;
                        case 645:   //|645|月|「洋上補給」物資の調達|三式弾廃棄, (燃料750, 弾薬750, ドラム缶(輸送用)x2, 九一式徹甲弾)保有
                            this.Progresses.Add(new ProgressDiscard(q, 1, true, new[] { 18 }));
                            break;
                        case 643:   //|643|季|主力「陸攻」の調達|零式艦戦21型x2廃棄, (九六式陸攻x1, 九七式艦攻x2)保有
                            this.Progresses.Add(new ProgressDiscard(q, 2, true, new[] { 20 }, -1));
                            break;
                        case 653:   //|653|季|工廠稼働！次期作戦準備！|14cm単装砲x6廃棄, (家具コイン6000, 35.6cm連装砲x3, 九六式艦戦x3)保有
                            this.Progresses.Add(new ProgressDiscard(q, 6, true, new[] { 4 }, -1));
                            break;
                        case 663:   //|663|季|新型艤装の継続研究|大口径主砲x10廃棄, 鋼材18000保有
                            this.Progresses.Add(new ProgressDiscard(q, 10, true, new[] { 3 }));
                            break;
                        ...
                        case 702:   //|702|艦の「近代化改修」を実施せよ！|改修成功2
                            this.Progresses.Add(new ProgressModernization(q, 2));
                            break;
                        case 703:   //|703|「近代化改修」を進め、戦備を整えよ！|改修成功15
                            this.Progresses.Add(new ProgressModernization(q, 15));
                            break;
