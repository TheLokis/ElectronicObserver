...
namespace ElectronicObserver.Data
{
	...
	public class ShipDataMaster : ResponseWrapper, IIdentifiable
	{
        ...
        /// 護衛空母か
        /// </summary>
        public bool IsEscortAircraftCarrier => this.ShipType == ShipTypes.LightAircraftCarrier && this.ASW.Minimum > 0;
		...
		private static readonly Color[] ShipNameColors = new Color[] {
            Utility.ThemeManager.GetColor(Utility.ThemeColors.MainFontColor),
