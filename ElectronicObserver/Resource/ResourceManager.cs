	...
	public sealed class ResourceManager
	{
		...
		private void LoadFromArchive(string path)
		{
			...
			using (var archive = new ZipArchive(File.OpenRead(path), ZipArchiveMode.Read))
			{
				...
				LoadImageFromArchive(this.Icons, archive, mstpath + @"Item/AviationMaterial.png", "Item_AviationMaterial");
                ...
                LoadImageFromArchive(this.Equipments, archive, mstpath + @"Equipment/Unknown.png", "Equipment_Reserved48");                   // 艦これ本体側が未実装
