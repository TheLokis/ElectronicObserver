	...
	public class start : APIBase
	{
		...
		public override void OnRequestReceived(Dictionary<string, string> data)
		{
			...
			*/
			...
			Utility.Logger.Add(2, string.Format("#{0}「{1}」가 원정「{2}: {3}」에 출발했습니다.", 
				deckID, KCDatabase.Instance.Fleet[deckID].Name, destination, KCDatabase.Instance.Mission[destination].Name));
